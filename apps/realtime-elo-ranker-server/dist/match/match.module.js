...
const match_controller_1 = require("./match-controller/match.controller");
const match_service_1 = require("./match-service/match.service");
...
exports.MatchModule = MatchModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [match_service_1.MatchService, event_gateway_1.EventGateway],
